<template>
  <div id="commandTool">
    ...
    <b-form class="my-2">
      <b-form-group id="group1" label="Your action:" label-for="input-1">
        <b-form-input
          id="input-1"
          required
    ...
    <b-form class="my-1">
      <b-form-group id="group2" label="Your command:" label-for="input-2">
        <b-form-input
          id="input-2"
          required
    ...
    <b-modal size="xl" id="modal-1" title="Instructions for using command tool">
      <p class="mb-2">The command tool have the following <b>actions</b>:</p>
      <div class="box p-2">
        <h5>event</h5>
        &#8227; <b>Topic</b>: "/cyborg_controller/register_event".<br />
        &#8227; <b>msg type</b>: "std_msgs/String".<br />
        &#8227; <b>Example</b>: action: <i>event</i> , command:
        <i>start</i>.<br />
        &#8227; <b>Info</b>: The <b><i>event</i></b> action is used to change
        the SMACH <i>SystemState</i>. In the example we change from state
        <i>suspension</i> to state <i>idle</i>. The only possible transition
        from state <i>suspension</i> to state <i>idle</i> is "start". The
      ...
      <div class="box p-2">
        <h5>speech</h5>
        &#8227; <b> Topic</b>: "/cyborg_audio/text_to_speech".<br />
        &#8227; <b>msg Type</b>: "std_msgs/String".<br />
        &#8227; <b>Example</b>: action: <i>speech</i> , command:
        <i>hello</i>.<br />
        &#8227; <b>Info</b>: The <b><i>speech</i></b> action is used to make the
      ...
      <div class="box p-2">
        ...
        <b
          ...
          unconcerned</b
        >.(can be found in controller node in cyborg_controller)<br />
        &#8227; <b>Topic</b>: "/cyborg_audio/text_to_speech".<br />
        &#8227; <b>msg Type</b>: "std_msgs/String".<br />
        &#8227; <b>Example</b>: action: <i>emotion</i> , command:
        <i>angry</i>.<br />
        &#8227; <b>Info</b>: The <b><i>emotion</i></b> action is used to set the
        ...
        'controller' using the <i>EmotionalState</i> msg. In the example we set
        the emotional state of the emotion-system to angry.
      </div>
      <div class="box p-2">
        <h5>emotionswitch</h5>
        &#8227; <b>Commands</b>: <b>on, ON, off, OFF</b>.<br />
        &#8227; <b>Topic</b>: "/cyborg_controller/emotional_controller".<br />
        &#8227; <b>msg Type</b>: "std_msgs/String".<br />
        &#8227; <b>Example</b>: action: <i>emotionswitch</i> , command:
        <i>off</i>.<br />
        &#8227; <b>Info</b>: The <b><i>emotionswitch</i></b> action is used to
